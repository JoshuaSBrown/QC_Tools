...
int main(void){
  ...
  cerr << "Testing: getPropOption" << endl;
  {
    ...
    vector<string> allowed_ext = propSisterFile1.getPropOption("ALLOWED_SISTER_FILE_EXT");
    vector<string> file_name = propSisterFile1.getPropOption("SISTER_FILE_NAME");
    vector<string> file_path = propSisterFile1.getPropOption("SISTER_FILE_PATH");
    vector<string> file_path_name = propSisterFile1.getPropOption("SISTER_FILE_PATH_NAME");
    vector<string> fileExist = propSisterFile1.getPropOption("SISTER_FILE_EXISTS");
